...
![](assets/project-id-registration/dashboard-signup.png)
...
![](assets/project-id-registration/auth-code.png)

### Press The Create Button To Create Your Project

![](assets/project-id-registration/create-button.png)

### Enter A Project Name

Please enter your game title and press create.

![](assets/project-id-registration/create-project.png)
...
![](assets/project-id-registration/project-id.png)
...
![](assets/project-id-registration/not-valid.png)
...
![](assets/project-id-registration/save-settings.png)
