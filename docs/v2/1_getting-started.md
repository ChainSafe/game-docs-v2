...
Web Graphics Library Sign verify has been altered slightly. Istead of it being an EVM.Call, it is now handled entirely within the library. You can see the changes between the old and the new versions below.
